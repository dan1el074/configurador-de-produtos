...
INSERT INTO tb_products (id, name, abbreviation, options) VALUES (0, 'Niveladora de Docas Avançada', 'NDA', '{"options": [1,2,3,4,5], "rules": {"fosso": [["padrão","F500 P500"], ["especial",""]]}}');
...
INSERT INTO tb_products (id, name, abbreviation, options) VALUES (9, 'Mesa Extra Baixa', 'MEB', '{"options": [1,2,3,4,5], "rules": {"opções": [["formato em U","U"], ["formato em E","E"]]}}');
